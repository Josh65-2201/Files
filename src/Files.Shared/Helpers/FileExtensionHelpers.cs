...
namespace Files.Shared.Helpers
{
	...
	public static class FileExtensionHelpers
	{
		...
		{
			return HasExtension(fileExtensionToCheck, ".zip", ".msix", ".appx", ".msixbundle", ".appxbundle", ".7z", ".rar", ".tar", ".mcpack", ".mcworld", ".mrpack", ".jar", ".gz", ".lzh", ".bz2");
		}
		...
		public static bool IsBrowsableZipFile(string? filePath, out string? ext)
		{
			...
			ext = new[] { ".zip", ".7z", ".rar", ".tar", ".gz", ".lzh", ".mrpack", ".jar", ".bz2" }
